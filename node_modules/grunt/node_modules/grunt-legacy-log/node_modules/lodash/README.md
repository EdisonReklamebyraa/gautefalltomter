...
**Notes:**
 * Don’t assign values to [special variable](http://nodejs.org/api/repl/#repl_repl_features) `_` when in the REPL
 ...
 * [_.template](https://lodash.com/docs#template) supports [*“imports”*](https://lodash.com/docs#templateSettings_imports) options & [ES6 template delimiters](http://people.mozilla.org/~jorendorff/es6-draft/#sec-literals-string-literals)
