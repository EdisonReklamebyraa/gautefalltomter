  ...
  css: {
    ...
    options: {
      livereload: {
        ...
        // you can pass in any other options you'd like to the https server, as listed here: http://nodejs.org/api/tls/#tls_tls_createserver_options_secureconnectionlistener
      }
    },
  },
},
